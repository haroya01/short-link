...
public final class AdminException extends RuntimeException implements DomainException {

  private final AdminErrorCode errorCode;
  private final Map<String, Object> properties = new LinkedHashMap<>();

  public AdminException(AdminErrorCode errorCode, Object... messageArgs) {
    super(errorCode.format(messageArgs));
    this.errorCode = errorCode;
  }

  public AdminException with(String key, Object value) {
