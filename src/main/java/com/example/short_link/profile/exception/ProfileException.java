...
public final class ProfileException extends RuntimeException implements DomainException {

  private final ProfileErrorCode errorCode;
  private final Map<String, Object> properties = new LinkedHashMap<>();

  public ProfileException(ProfileErrorCode errorCode, Object... messageArgs) {
    super(errorCode.format(messageArgs));
    this.errorCode = errorCode;
  }

  public ProfileException with(String key, Object value) {
