...
/**
 * Anonymous-readable profile visit stats. Returns 404 ({@code UserException}) when the user doesn't
 * exist OR hasn't opted into public stats — the visibility flip is the only thing that exposes this
 * endpoint per-username, so the existence of an opted-out profile isn't leaked.
 */
@RestController
