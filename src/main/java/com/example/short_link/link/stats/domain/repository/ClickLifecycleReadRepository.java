...
/**
 * Visitor-lifecycle reads — return-rate split (new vs returning visitors via visitor_hash count)
 * and per-day-since-creation click distribution used for half-life computation.
 */
public interface ClickLifecycleReadRepository extends Repository<ClickEventEntity, Long> {
