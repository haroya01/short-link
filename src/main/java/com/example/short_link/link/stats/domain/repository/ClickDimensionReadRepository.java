...
/**
 * "Top X by Y" breakdowns for a single link — referrer / device / utm / geo / destination. Each
 * query returns the top {@code Pageable} entries ordered by count desc; callers typically request
 * {@code TOP_50} for the stats page.
 */
public interface ClickDimensionReadRepository extends Repository<ClickEventEntity, Long> {
