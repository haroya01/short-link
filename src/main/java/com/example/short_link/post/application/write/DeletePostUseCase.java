...
public class DeletePostUseCase {
  ...
  /**
   * 본인 글을 영구 삭제. block → revision 본문 데이터에 더해, 같은 글에 달린 댓글 (PII 포함) · 좋아요 · 북마크 같은 상호작용 행도 함께 정리해 고아
   * 데이터를 남기지 않는다. 마지막에 post 를 지운다. 분석 데이터 (click_event 등) 는 별도 도메인이라 영향 없음.
   */
  @Transactional
